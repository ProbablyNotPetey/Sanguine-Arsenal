...
//            ModelPart armorLeftBoot = new ModelPart(this);
...
//
//            ModelPart armorRightBoot = new ModelPart(this);
...
//            skirt_left.texOffs(0, 107).addBox(-0.0279F, -1.2468F, 0.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F));
//            skirt_left.texOffs(0, 107).addBox(0.4721F, -0.2468F, 0.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F));
//            skirt_left.texOffs(0, 107).addBox(0.7721F, 0.6532F, 0.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F));
//            skirt_left.texOffs(0, 107).addBox(1.0221F, 1.6532F, 0.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F));
//            skirt_left.texOffs(0, 107).addBox(1.2721F, 2.6532F, 0.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F));
//
...
//            armorRightArm.texOffs(84, 73).addBox(-12.15F, 7.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
//            armorRightArm.texOffs(33, 64).addBox(-12.5F, 4.0F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
//            armorRightArm.texOffs(76, 55).addBox(-12.4F, -1.2F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
//            armorRightArm.texOffs(60, 58).addBox(-12.9F, -2.2F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
//            armorRightArm.texOffs(15, 51).addBox(-12.9F, 5.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
//            armorRightArm.texOffs(92, 25).addBox(-13.4F, -2.7F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
//            armorRightArm.texOffs(55, 68).addBox(-12.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
//
//            ModelPart armorbipedLeftArm = new ModelPart(this);
//            armorbipedLeftArm.setPos(-1.0F, 0.0F, 0.0F);
//            leftArm.addChild(armorbipedLeftArm);
//            armorbipedLeftArm.texOffs(0, 0).addBox(0.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
//            armorbipedLeftArm.texOffs(82, 85).addBox(1.15F, 7.5F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
//            armorbipedLeftArm.texOffs(0, 66).addBox(-0.5F, 4.0F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
//            armorbipedLeftArm.texOffs(65, 5).addBox(-0.1F, -2.2F, -3.0F, 5.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
//            armorbipedLeftArm.texOffs(79, 30).addBox(0.4F, -1.2F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
//            armorbipedLeftArm.texOffs(93, 81).addBox(2.4F, -2.7F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
//            armorbipedLeftArm.texOffs(62, 15).addBox(2.9F, 5.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))

        }
        if (slot == EquipmentSlot.LEGS) {
//            ModelPart armorbipedRightLeg = new ModelPart(this);
...
//            armorHead.texOffs(0, 34).addBox(-3.5F, -2.4F, -4.5F, 7.0F, 3.0F, 9.0F, new CubeDeformation(0.0F))
//            armorHead.texOffs(15, 46).addBox(-3.5F, -6.4F, -4.2F, 7.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
//            armorHead.texOffs(35, 11).addBox(-3.5F, -6.5F, 3.1F, 7.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
//            armorHead.texOffs(35, 0).addBox(-4.5F, -8.4F, -4.4F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.0F))
//
...
//            armorBody.addChild(cape);
        ...
        //todo: this might cause issues idk
